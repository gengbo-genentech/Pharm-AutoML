...
parser = argparse.ArgumentParser("AutoML")
...
parser.add_argument("--allowMissing", type=str2bool, help="allow data without imputation")
...
# classifier
parser.add_argument("--PCA_featureReduction_orNot", type=str2bool, help='use PCA to reduce feature dimension or not')
parser.add_argument("--PCA_featureReduction_num", type=str2int, help='number of PCA features')
parser.add_argument("--clfs", type=lambda s: re.split(',', s), required=True, help='list of classifiers')
parser.add_argument("--n_fold", type=str2int, help="total fold number")
parser.add_argument("--n_repeats", type=str2int, help="number of repeat")
parser.add_argument("--useDropColFeaImport", type=str2bool, help='use drop column feature importance or not')
